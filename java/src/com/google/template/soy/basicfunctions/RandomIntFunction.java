 ...
 */
@Singleton
class RandomIntFunction implements SoyTofuFunction, SoyJsSrcFunction, SoyJavaSrcFunction, SoyGoSrcFunction {
  ...
  @Override public GoExpr computeForGoSrc(List<GoExpr> args) {
    ...
    return toIntegerGoExpr(GoCodeUtils.genNewIntegerData(
        GoCodeUtils.UTILS_LIB + ".RandomInt(" + GoCodeUtils.genIntegerValue(arg) + ")"));
  }
