 ...
 */
@Singleton
class LengthFunction implements SoyTofuFunction, SoyJsSrcFunction, SoyJavaSrcFunction, SoyGoSrcFunction {
  ...
  @Override public GoExpr computeForGoSrc(List<GoExpr> args) {
    ...
    return toIntegerGoExpr(
        GoCodeUtils.genNewIntegerData(arg.getText() + ".(soyutil.Lener).Len()"));
  }
