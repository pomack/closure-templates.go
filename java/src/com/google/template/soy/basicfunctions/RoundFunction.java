 ...
 */
@Singleton
class RoundFunction implements SoyTofuFunction, SoyJsSrcFunction, SoyJavaSrcFunction, SoyGoSrcFunction {
  ...
  @Override public GoExpr computeForGoSrc(List<GoExpr> args) {
    ...
    String numDigitsAfterPtExprText =
        (numDigitsAfterPt != null) ?
        GoCodeUtils.genMaybeCast(numDigitsAfterPt, IntegerData.class) : "nil";
