...
import static com.google.template.soy.gosrc.restricted.SoyGoSrcFunctionUtils.toFloatGoExpr;
 ...
 */
@Singleton
class FloorFunction implements SoyTofuFunction, SoyJsSrcFunction, SoyJavaSrcFunction, SoyGoSrcFunction {
  ...
  @Override public GoExpr computeForGoSrc(List<GoExpr> args) {
    ...
    return toFloatGoExpr(GoCodeUtils.genNewFloatData(
