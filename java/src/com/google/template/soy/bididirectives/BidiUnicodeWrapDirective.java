 ...
 */
@Singleton
public class BidiUnicodeWrapDirective implements SoyTofuPrintDirective, SoyJsSrcPrintDirective, SoyGoSrcPrintDirective {
  ...
  @Override public GoExpr applyForGoSrc(GoExpr str, List<GoExpr> args) {
    return new GoExpr(
        "soyutil.BidiUnicodeWrap(" + bidiGlobalDirProvider.get() + ", " + GoCodeUtils.genCoerceString(str) + ")",
        String.class,
        Integer.MAX_VALUE);
  }
