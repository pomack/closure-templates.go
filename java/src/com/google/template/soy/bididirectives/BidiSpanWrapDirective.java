 ...
 */
@Singleton
public class BidiSpanWrapDirective implements SoyTofuPrintDirective, SoyJsSrcPrintDirective, SoyGoSrcPrintDirective {
  ...
  @Override public GoExpr applyForGoSrc(GoExpr str, List<GoExpr> args) {
    return new GoExpr(
        "soyutil.BidiSpanWrap(" + bidiGlobalDirProvider.get() + ", " + GoCodeUtils.genCoerceString(str) + ")",
        String.class,
        Integer.MAX_VALUE);
  }
