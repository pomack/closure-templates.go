 ...
 */
@Singleton
class BidiTextDirFunction implements SoyTofuFunction, SoyJsSrcFunction, SoyGoSrcFunction {
  ...
  @Override public GoExpr computeForGoSrc(List<GoExpr> args) {
    ...
    String callText = "soyutil.BidiTextDir(" + GoCodeUtils.genCoerceString(text) + ", " + opt_isHtml + ")";
