 ...
 */
@Singleton
class BidiMarkAfterFunction implements SoyTofuFunction, SoyJsSrcFunction, SoyGoSrcFunction {
  ...
  @Override public GoExpr computeForGoSrc(List<GoExpr> args) {
    ...
    String callText = "soyutil.BidiMarkAfter(" + bidiGlobalDirProvider.get() + ", " + GoCodeUtils.genCoerceString(text) + ", " + opt_isHtml + ")";
